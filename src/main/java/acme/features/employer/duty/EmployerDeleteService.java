...
public class EmployerDeleteService implements AbstractDeleteService<Employer, Duty> {
	...
	public void validate(final Request<Duty> request, final Duty entity, final Errors errors) {
		...
		/*
		 * Collection<Applications> a = this.repository.findApplicationsByDutyId(entity.getId());
		 * errors.state(request, a.size() == 0, "title", "employer.Duty.existsApplicationsForIt");
		 */
